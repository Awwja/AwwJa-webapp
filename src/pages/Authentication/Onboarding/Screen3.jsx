    ...
    <div className='bg-linear-to-b from-[#BD5E1F] to-white'>
      ...
      <div className='flex flex-col items-center justify-center gap-y-4 mt-20'>
        ...
        <div className='mt-6'>
          ...
          <p className='text-black text-lg max-w-90 w-full text-center mt-4 font-semibold font-family'>
            Shop from real sellers with real ratings and reviews. No funny
            business{" "}
          </p>
        </div>
